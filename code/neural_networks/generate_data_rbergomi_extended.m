...
%% Define model
model = rBergomiExtClass('eta',2.1,'rho',-0.90,'alpha',-0.4,...
                         'beta',-0.4,'s0',100);
...
model.pricerSettings.N_vol_grp = [0.2,0.3,Inf]';
model.pricerSettings.N = [100000,50000,25000]';

%% Define inputs and outputs:
seed_train = 1495124;
seed_test = 5159122;

params = {'eta','rho','alpha','beta','xi'};

[eta_settings,rho_settings,alpha_settings,beta_settings,xi_settings] = deal(struct);
...
alpha_settings.method = 'unif_discrete_random_grid';
alpha_settings.lb = -0.50;
alpha_settings.ub =  0.50;
alpha_settings.n = 100;
alpha_settings.resampleEvery = 5000;

beta_settings.method = 'unif_cont';
beta_settings.lb = -0.50;
beta_settings.ub =  0.50;
...
xi_settings.vol0_low = [0.075;0.075;0.075;...
                        0.075;0.075;0.075;...
                        0.30;0.30;0.30;...
                        0.075;0.075;0.075;...
                        0.075;0.075;0.075;...
...
xi_settings.vs_rate_low = [0.075;0.075;0.075;...
                           0.30;0.30;0.30;...
                           0.075;0.075;0.075;...
                           0.075;0.075;0.075;...
                           0.075;0.075;0.075;...
...
xi_settings.num_flat_sections = [NaN;NaN;NaN;...
                                 ...
                                 NaN;...
                                 NaN];
xi_settings.lb = 0.075.^2;
xi_settings.ub = 1;

samplingSettings = {eta_settings,rho_settings,alpha_settings,beta_settings,...
                    xi_settings};
...
saveFolderTrain = [dataFolder,'\temp\rbergomi_extended_train_temp'];
saveFolderTest = [dataFolder,'\temp\rbergomi_extended_test_temp'];
folderSlash = '\';
...
[trainData,trainHeader,trainInputFail,trainErrFail] = ComputeTrainingData(...
                                        ...
                                        'getInputsOnly',false,...
                                        'reuse_numbers_for_each_alpha',true,...
                                        'seed',seed_train);
...
%save([dataFolder,'\training_and_test_data\','rbergomi_extended_trainData_iv.mat'],'trainData_iv','-v7.3')
%save([dataFolder,'\training_and_test_data\','rbergomi_extended_testData_iv.mat'],'testData_iv','-v7.3')


%% Split each dataset into three separate ones depending on the expiries:
idxPar1 = (1:4+max(find(Txi < 0.008))+1)';
idxPar2 = (1:4+max(find(Txi < 0.03))+1)';
idxPar3 = (1:4+max(find(Txi < 0.12))+1)';
idxPar4 = (1:4+max(find(Txi < 0.40))+1)';
idxPar5 = (1:4+max(find(Txi < 1.00))+1)';
idxPar6 = (1:4+max(find(Txi < 3.00))+1)';
...
writetable(trainData_iv_1_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_training_data_1.csv']);
writetable(trainData_iv_2_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_training_data_2.csv']);
writetable(trainData_iv_3_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_training_data_3.csv']);
writetable(trainData_iv_4_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_training_data_4.csv']);
writetable(trainData_iv_5_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_training_data_5.csv']);
writetable(trainData_iv_6_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_training_data_6.csv']);
...
writetable(testData_iv_1_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_test_data_1.csv']);
writetable(testData_iv_2_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_test_data_2.csv']);
writetable(testData_iv_3_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_test_data_3.csv']);
writetable(testData_iv_4_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_test_data_4.csv']);
writetable(testData_iv_5_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_test_data_5.csv']);
writetable(testData_iv_6_tbl,[dataFolder,'\training_and_test_data\rbergomi_extended\rbergomi_extended_test_data_6.csv']);
